...
public class TestOWL extends AbstractTest{
	...
	public void prueba2() {
		...
		Resource juan = infmodel.getResource("http://www.ejemplo.com/juan");
		System.out.println("juan tiene tripes:");
		printStatements(infmodel, juan, null, null);
	...
	public void testValidarOWL() {
		...
		System.out.println("=============");
		Model schema = RDFDataMgr.loadModel("file:test-files/owl/modelo1.1.n3");
		Model data = RDFDataMgr.loadModel("file:test-files/owl/prueba3/datos.n3");
